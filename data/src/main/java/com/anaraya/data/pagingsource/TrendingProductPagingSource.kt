...
class TrendingProductPagingSource @Inject constructor(remoteDataSource: RemoteDataSource):BasePagingSource<Product>(remoteDataSource) {
    override suspend fun fetchData(page: Int): List<Product> {
        return remoteDataSource.getTrendingProducts(page)
    }
}