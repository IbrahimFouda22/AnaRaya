...
open class PasswordInValidFormatException(message: String?):ValidateException(message)
class CurrentPasswordInValidFormatException(message: String?):PasswordInValidFormatException(message)
class NewPasswordInValidFormatException(message: String?):PasswordInValidFormatException(message)
...
class IllegalStateException(message: String?):AnaRayaException(message)