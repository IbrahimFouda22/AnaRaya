...
class ProductDetailsFragment : Fragment(), ProductInteractionListener {
    ...
    private val viewModel by viewModels<ProductDetailsViewModel> {
        ProductDetailsViewModel.createFactory(navArgs.productId, navArgs.isPoints, factory)
    }
    ...
    override fun onCreateView(
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.product.collectLatest {
                ...
                if (!it.messageNotify.isNullOrEmpty()) {
                    Toast.makeText(context, it.messageNotify, Toast.LENGTH_SHORT).show()
                }
