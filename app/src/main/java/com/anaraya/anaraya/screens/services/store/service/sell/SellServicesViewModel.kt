...
@HiltViewModel
class SellServicesViewModel @Inject constructor(
    ...
    private val _sellUiState = MutableStateFlow(SellServicesUiState())
    val sellUiState = _sellUiState as StateFlow<SellServicesUiState>
    ...
    private fun getCategories() {
        ...
        viewModelScope.launch {
            try {
                onGetCategoriesSuccess(manageStoreUseCase.getStoreServicesCategories())
    ...
    fun addItem(
        ...
        viewModelScope.launch {
            try {
                onAddItemSuccess(
                    manageStoreUseCase.storeAddService(
                        title,
                        categoryId,
                        subCategoryId,
                        itemDescription,
