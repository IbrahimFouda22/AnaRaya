...
@HiltViewModel
class ExploreServiceViewModel @Inject constructor(
    ...
    private val _exploreUiState = MutableStateFlow(ExploreServiceUiState())
    val exploreUiState = _exploreUiState as StateFlow<ExploreServiceUiState>
    ...
    private fun getExploreCategories() {
        ...
        viewModelScope.launch {
            try {
                onGetExploreCategoriesSuccess(manageStoreUseCase.getStoreServicesCategories())
