...
import com.anaraya.anaraya.screens.more.feedback.adapter.FeedBackAdapter
import com.anaraya.anaraya.screens.more.feedback.question1.Question1Fragment
import com.anaraya.anaraya.screens.more.feedback.question2.Question2Fragment
...
class FeedBackFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.tabFeedBack.addTab(binding.tabFeedBack.newTab().setText(getString(R.string.question1)))
        binding.tabFeedBack.addTab(binding.tabFeedBack.newTab().setText(getString(R.string.question2)))
